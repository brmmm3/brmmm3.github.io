---
layout: post
title: fastlogging-rs
tagline: A blazing-fast logging framework for 8 programming languages — up to 200× faster than Python logging.
date: 2026-09-16 08:40:00 +0100
categories: posts
---
...
<figure>
    <img src="https://raw.githubusercontent.com/brmmm3/fastlogging-rs/master/docs/benchmarks/short-noexc-file.svg" width="48%" alt="fastlogging-rs file benchmark">
    <figcaption>fastlogging-rs file writer benchmark</figcaption>
</figure>

<figure>
    <img src="https://raw.githubusercontent.com/brmmm3/fastlogging-rs/master/docs/benchmarks/short-noexc-rotate.svg" width="48%" alt="fastlogging-rs rotating file benchmark">
    <figcaption>fastlogging-rs rotating file writer benchmark</figcaption>
</figure>
...
If your application spends time logging, fastlogging-rs can provide substantial performance improvements
with minimal code changes — in whichever language you happen to be writing.
